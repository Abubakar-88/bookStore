...
public List<E> findWithNameQueryObject( String queryName, int firstResult, int maxResult){
        EntityManager entityManager = entityManagerFactory.createEntityManager();
        Query query = entityManager.createNamedQuery(queryName);
        query.setFirstResult(firstResult);
        query.setMaxResults(maxResult);
...
public List<E> findWithNameQuery(String queryName, Map<String, Object> parameters){
        ...
        Set<Entry<String, Object>> setParameteres = parameters.entrySet();

        for(Entry<String, Object> entry : setParameteres){
